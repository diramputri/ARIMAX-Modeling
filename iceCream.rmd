...
```{r}
#income variable lagged one period
in1=lag(Icecream$income,1)
#income variable lagged two periods
in2=lag(Icecream$income,2)
#create matrix
df2=cbind(Icecream$temp,Icecream$income,in1,in2)
print(df2)
```
...
arimax2=auto.arima(Icecream$cons,xreg=Icecream$temp+Icecream$income)
summary(arimax2)
#temperature and income at lags 0,1
arimax3=auto.arima(Icecream$cons,xreg=Icecream$temp+Icecream$income+in1)
summary(arimax3)
#temperature and income at lags 0,1,2
arimax4=auto.arima(Icecream$cons,xreg=Icecream$temp+Icecream$income+in1+in2)
summary(arimax4)
```
